...
if (isset($_POST['frmAddUser'])) {
    ...
    $reponseBD = adduser($nom, $prenom, $adresse, $mail, $telephone, $nomPhoto, $role, $password);
...
if (isset($_POST['frmEditUser'])) {
    ...
    $reponseBD = edituser($_POST['idUser'], $nom, $prenom, $adresse, $mail, $telephone, $nomPhoto, $role, $password);
